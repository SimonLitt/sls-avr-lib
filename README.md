...
The following functionality is available today:
  * LCD HD44780 (pin connected): 4-bit & 8-bit support, read mode support, support for connecting multiple displays to one MCU(Not optimal, but you can use one of the displays for debugging, in normal mode it is better to use only one display);
